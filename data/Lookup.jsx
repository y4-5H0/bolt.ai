...
export default {
  ...
  SIGNIN_HEADING: 'Continue With Bolt.ai 2.0',
  SIGNIN_SUBHEADING: 'To use Bolt.ai you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using Bolt.ai, you agree to the collection of usage data for analytics.',
